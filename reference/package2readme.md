...
#> 
#> A collection of tools which allow to manipulate and
#>         analyze code.
#> 
#> 
#> ## Installation
...
#> 
#> Dietrich J, Sauer P, Klein D, Giannousakis A, Bonsch M, Bodirsky B, Baumstark L, Richters O, Pflüger M, Rein P (2026). _lucode2: Code Manipulation and Analysis Tools_. R package version 0.55.0.
#> 
