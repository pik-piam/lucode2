...
R package **lucode2**, version **0.43.14**
...
Dietrich J, Führlich P, Klein D, Giannousakis A, Bonsch M, Bodirsky B, Baumstark L, Richters O, Pflüger M (2023). _lucode2: Code Manipulation and Analysis Tools_. doi:10.5281/zenodo.4389418 <https://doi.org/10.5281/zenodo.4389418>, R package version 0.43.14, <https://github.com/pik-piam/lucode2>.
...
@Manual{,
  ...
  year = {2023},
  note = {R package version 0.43.14},
