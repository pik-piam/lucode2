...
R package **lucode2**, version **0.11.6.9001**
...
Dietrich J, Klein D, Giannousakis A, Bonsch M, Bodirsky B, Baumstark L (2021). _lucode2: Code Manipulation and Analysis Tools_. doi:
10.5281/zenodo.4389418 (URL: https://doi.org/10.5281/zenodo.4389418), R package version 0.11.6.9001, <URL: https://github.com/pik-piam/lucode2>.
...
@Manual{,
  ...
  year = {2021},
  note = {R package version 0.11.6.9001},
